...
/**
 * Abstraction of multiple source to single destination firewall intent.
 */
@Beta
public final class FirewallIntent extends ConnectivityIntent {
     ...
     *                                  not more than 1
     */
    private FirewallIntent(ApplicationId appId,
                                          Key key,
     ...
     */
    public static Builder builder(FirewallIntent intent) {
    ...
    public static final class Builder extends ConnectivityIntent.Builder {
         ...
         * @param intent initial intent
         */
        protected Builder(FirewallIntent intent) {
            super(intent);
         ...
         */
        public FirewallIntent build() {

            return new FirewallIntent(
                    appId,
                    key,
                    selector,
                    treatment,
